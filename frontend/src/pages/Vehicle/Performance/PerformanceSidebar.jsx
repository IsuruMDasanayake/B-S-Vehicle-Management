...
const PerformanceSidebar = ({ isMobileOpen, closeMobileOpen }) => {
            ...
            <div key={idx} style={{ marginBottom: '1.5rem' }}>
              ...
              <ul style={{ listStyle: 'none' }}>
                {visibleItems.map((item) => {
                  const isActive = location.pathname === item.path || (item.path !== '/vehicle/admin/performance' && location.pathname.startsWith(item.path));
